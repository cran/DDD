dd_simplex = function(trparsopt,idparsopt,trparsfix,idparsfix,pars2,brts,missnumspec)
{
...
for(i in 1:(numpar + 1))
{
   fv[i] = -dd_loglik_choosepar(v[,i],trparsfix,idparsopt,idparsfix,pars2,brts,missnumspec)
}
